...
import { htmlEntityEncode } from '../../utils';
  ...
  return (
    <div className="space-y-4">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <div className="bg-elevated rounded-lg border border-border p-4">
          ...
          <textarea
            ...
            placeholder="Enter text to HTML entity encode..."
        ...
        <div className="bg-elevated rounded-lg border border-border p-4">
          <div className="flex items-center justify-between mb-3">
            <h3 className="font-medium text-primary">HTML Entity Encoded Output</h3>
          ...
          <div className="h-64 overflow-auto bg-surface rounded-md p-3 font-mono text-sm">
            <pre className="whitespace-pre-wrap break-all">{output || 'HTML entity encoded text will appear here'}</pre>
          </div>
        </div>
      </div>
      ...
      <div className="p-3 bg-border/10 rounded-lg text-sm text-muted">
        <p><strong>Tip:</strong> HTML entity encoding converts special characters to their HTML entity equivalents for safe display in HTML.</p>
      </div>
    </div>
  );
}
